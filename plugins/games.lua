--[[
الالعاب ل سورس ماكس
تم تعديل الملف واضافه الالعاب من قبل اونلاين @M0000
--]]
...
return "-> أهلًا عزيزي "..msg.TheRankCmd.." الالعاب بالتاكيد تم تفعيلها ." 
else 
redis:del(lana..'lock_geams'..msg.chat_id_) 
return "-> أهلًا عزيزي "..msg.TheRankCmd.."  تم تفعيل الالعاب ." 
end 
end
...
return "-> أهلًا عزيزي "..msg.TheRankCmd.."  الالعاب بالتأكيد معطله ." 
else
redis:set(lana..'lock_geams'..msg.chat_id_,true)  
return "-> أهلًا عزيزي "..msg.TheRankCmd.."  تم تعطيل الالعاب ." 
end   
end
...
💠│•⊱محيبس ༜ لعبه محيبس الشهيره 📼╽•⊱المختلف ༜ لعبه اختلاف لسمايل
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
