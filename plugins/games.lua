...
sendMsg(msg.chat_id_,msg.id_,TEST)   
redis:setex(dreem.."SET:t" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
return '◀️┇اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(dreem..':Set_Smile:'..msg.chat_id_))..'`'
else
...
redis:set(dreem.."GAME:SE"..msg.chat_id_,true) 
K1 = [[
✖️¦12+12+4 ⚜️
]]
K2 = [[
...
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'68') 
elseif SENDTEXT:find('114') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'114') 
elseif SENDTEXT:find('164') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'164') 
elseif SENDTEXT:find('194') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'194') 
elseif SENDTEXT:find('28') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'28') 
elseif SENDTEXT:find('62') then
redis:set(dreem.."GAME:CHER"..msg.chat_id_,'62') 
elseif SENDTEXT:find('109') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'109') 
elseif SENDTEXT:find('88') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'88') 
elseif SENDTEXT:find('192') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'192') 
elseif SENDTEXT:find('115') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'115') 
elseif SENDTEXT:find('124') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'124') 
elseif SENDTEXT:find('102') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'102') 
elseif SENDTEXT:find('107') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'107') 
elseif SENDTEXT:find('90') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'90') 
elseif SENDTEXT:find('182') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'182') 
elseif SENDTEXT:find('122') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'122') 
elseif SENDTEXT:find('195') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'195') 
elseif SENDTEXT:find('123') then
redis:set(dreem.."GAME:CHERE"..msg.chat_id_,'123') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:set(dreem.."eng:lsh"..msg.chat_id_,true) 
Ke1 = [[
✖️¦ 
...
redis:set(dreem.."eng:ken"..msg.chat_id_,'كتاب') 
elseif SENDTEXT:find('قطه') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'قطه') 
elseif SENDTEXT:find('باب') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'باب') 
elseif SENDTEXT:find('حاسبه') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'حاسبه') 
elseif SENDTEXT:find('فاره') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'فاره') 
elseif SENDTEXT:find('كنتور') then
redis:set(dreem.."GAME:CHER"..msg.chat_id_,'كنتور') 
elseif SENDTEXT:find('انترنت') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'انترنت') 
elseif SENDTEXT:find('منضده') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'منضده') 
elseif SENDTEXT:find('شيطان') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'شيطان') 
elseif SENDTEXT:find('ضوضاء') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'ضوضاء') 
elseif SENDTEXT:find('سنه') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'سنه') 
elseif SENDTEXT:find('بيت') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'بيت') 
elseif SENDTEXT:find('معده') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'معده') 
elseif SENDTEXT:find('كاحل') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'كاحل') 
elseif SENDTEXT:find('خجول') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'خجول') 
elseif SENDTEXT:find('هديه') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'هديه') 
elseif SENDTEXT:find('جزار') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'جزار') 
elseif SENDTEXT:find('تصميم') then
redis:set(dreem.."eng:ken"..msg.chat_id_,'تصميم') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:incrby(dreem..':User_Points:'..msg.chat_id_..data.id_,2)
end,nil)
redis:del(dreem..':List_Rolet:'..msg.chat_id_) 
...
if redis:get(dreem.."SET:t" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 6 then
...
local GETNUM = redis:get(dreem.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(dreem.."SET:t" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if (msg.text == redis:get(dreem.."GAME:CHER"..msg.chat_id_)) and redis:get(dreem.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(dreem..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(dreem.."GAME:S"..msg.chat_id_)
redis:del(dreem.."GAME:CHER"..msg.chat_id_)
...
if (msg.text == redis:get(dreem.."GAME:CHERE"..msg.chat_id_)) and redis:get(dreem.."GAME:SE"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(dreem..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(dreem.."GAME:SE"..msg.chat_id_)
redis:del(dreem.."GAME:CHERE"..msg.chat_id_)
...
if redis:get(dreem.."GAME:SE"..msg.chat_id_) then  
...
if (msg.text == redis:get(dreem.."eng:ken"..msg.chat_id_)) and redis:get(dreem.."eng:lsh"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(dreem..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(dreem.."eng:lsh"..msg.chat_id_)
redis:del(dreem.."eng:ken"..msg.chat_id_)
...
if redis:get(dreem.."eng:lsh"..msg.chat_id_) then  
