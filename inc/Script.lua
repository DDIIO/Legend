...
function download_to_file(url, file_name)
  ...
  if MsgText[2] == "ردود ريك"   then return unlock_replay(msg) end
  if MsgText[2] == "الاذاعه"  then return unlock_brod(msg) end
  if MsgText[2] == "ايدي ريك"   then return unlock_IID(msg) end
  if MsgText[2] == "ترحيب ريك"  then return unlock_Welcome(msg) end
  ...
  if MsgText[2] == "ردود ريك"   then return lock_replay(msg) end
  if MsgText[2] == "الاذاعه"  then return lock_brod(msg) end
  if MsgText[2] == "ايدي ريك"   then return lock_IID(msg) end
  if MsgText[2] == "ترحيب ريك"  then return lock_Welcome(msg) end
  ...
  return [[
  • ↵ مطور السورس : [Khalid](t.me/vvvkc)
• ↵ قناة السورس :[SourceSir](t.me/SourceSir)
®️
  ]]
  end
  ...
  "عيوني .",
  "عيون ["..Bot_Name.."] .",
  "ارحب يالدولة المستقله ."}
  local ss97 = {
  "لبييه .","عيوني .",
  "امرني .","وشفي ؟","ها .","شفيك تصيح !",
  "امرني يا حلو .","عيوني لك .","ارحب يالمجرة.",
  ...
  if msg.reply_id then
  sendMsg(msg.chat_id_,msg.id_,'اوك ')
  sendMsg(msg.chat_id_,msg.reply_id,'اهاا') 
  else
  end
  elseif Text:match("^"..Bot_Name.." رزله(.*)$") and msg.SudoUser then
  if msg.reply_id then
  sendMsg(msg.chat_id_,msg.id_,'اوك سيدي ??🍃')
  return sendMsg(msg.chat_id_,msg.reply_id,'تمام') 
  end
  ...
  return sendMsg(msg.chat_id_,msg.id_,"اكثر يلبى.")
  ...
  elseif Text== "خالد" then return sendMsg(msg.chat_id_,msg.id_,"[ khalid.](t.me/vvvkx")
elseif Text== "طلال" then return sendMsg(msg.chat_id_,msg.id_,"[ طلال الحارثي .](t.me/eeuiii")
  ...
  elseif Text== "هاي"  then return sendMsg(msg.chat_id_,msg.id_,"يزين هايك.")
