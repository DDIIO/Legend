...
sendMsg(msg.chat_id_,msg.reply_id,'ياي') 
else
end
...
return sendMsg(msg.chat_id_,msg.id_,lovm[math.random(#lovm)])
elseif Text== "غني" or Text=="غنيلي" 
elseif Text== "عزام" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](t.me/EEEEL")
elseif Text== "متعب" then return sendMsg(msg.chat_id_,msg.id_,"[ الشيخ متعب .](t.me/cebu9")
elseif Text== "محمد الحارثي" then return sendMsg(msg.chat_id_,msg.id_,"[الشيخ محمد .](t.me/mslll")
